...
const projects = [
  {
    ...
    tools: ["Python", "Pygame"],
    github: "https://github.com/Rothsource/Jump-Typing",
    icon: Gamepad2,
  },
  {
    ...
    github: "https://huggingface.co/spaces/rongsovannroth/URL_detection",
    icon: Shield,
  },
  {
    ...
    github: "https://github.com/Rothsource/BINARY-ANALYZE",
    icon: Binary,
  },
  {
    ...
    github: "https://github.com/Rothsource/Dos-Attack-Layer-7",
    icon: Zap,
  },
  {
    ...
    github: "https://www.localgrew.com/",
    icon: ShoppingCart,
  },
  {
    ...
    github: "https://www.facebook.com/reankitlek.center/",
    icon: GraduationCap,
  },
];
